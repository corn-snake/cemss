...
const renderClassCard = (mInfo, cInfo, block, topic)=>`
                    <article class="class-display">
                        ...
                        <main>
                            ...
                            <span><h3>Siguiente asignatura: </h3><span class="progActual">${topic > mInfo.length ? `Examen!` : `${cInfo.currentAct}</span> (${ topic }/${ mInfo.length })`}</span>
                        </main>
                    </article>
`;

export {renderGroups, renderClases, renderGroupInfo, renderTeacherOptions, renderClassCopyOptions, renderTermOptions, renderTerms, renderGroupOptions, renderClassCard, termFromMonthNumber};